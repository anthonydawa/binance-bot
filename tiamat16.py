...
from f16 import idx_array, initial_klines, watch_closed, watch_data, watch_loss
...
markets = ['ongusdt','omgusdt','renusdt','umausdt','iotausdt','compusdt','ankrusdt','maticusdt','utkusdt','rsrusdt']

channels = ['kline_1m']

market_caps7 = ['ONGUSDT']
market_caps8 = ['OMGUSDT']
market_caps9 = ['RENUSDT']
market_caps10 = ['UMAUSDT']
market_caps11 = ['IOTAUSDT']
market_caps12 = ['COMPUSDT']
market_caps13 = ['ANKRUSDT']
market_caps14 = ['MATICUSDT']
market_caps15 = ['UTKUSDT']
market_caps16 = ['RSRUSDT']
