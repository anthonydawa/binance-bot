...
from f11 import idx_array, initial_klines, watch_closed, watch_data, watch_loss
...
markets = ['egldusdt','flmusdt','tkousdt','avaxusdt','xrpusdt','funusdt','algousdt','xmrusdt','fttusdt','dodousdt']

channels = ['kline_1m']

market_caps7 = ['EGLDUSDT']
market_caps8 = ['FLMUSDT']
market_caps9 = ['TKOUSDT']
market_caps10 = ['AVAXUSDT']
market_caps11 = ['XRPUSDT']
market_caps12 = ['FUNUSDT']
market_caps13 = ['ALGOUSDT']
market_caps14 = ['XMRUSDT']
market_caps15 = ['FTTUSDT']
market_caps16 = ['DODOUSDT']
