...
markets = ['xrpusdt','adausdt','dotusdt','uniusdt','ltcusdt','linkusdt','bchusdt','xlmusdt','trxusdt','vetusdt','thetausdt','bttusdt','eosusdt','enjusdt','chzusdt','hotusdt','mkrusdt','runeusdt','avaxusdt','ksmusdt']
...
market_caps17 = ['MKRUSDT']
market_caps18 = ['RUNEUSDT']
market_caps19 = ['AVAXUSDT']
market_caps20 = ['KSMUSDT']
