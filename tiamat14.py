...
from f14 import idx_array, initial_klines, watch_closed, watch_data, watch_loss
...
apikey = '50gnFp5kH8wa5IseOO5Ez7OIlZhrgc0x9N3WlIqKj9Q7GsNhNEUiTIGy2DRSc3o4'
secretkey = '9tcc7MfWLXCLpwdOix6nPTzH3HhWB3jk6XgEwEF1xtruhWvHTGiV2ge5iRm3iNvx'

client = Client(apikey,secretkey)


markets = ['etcusdt','mkrusdt','zenusdt','crvusdt','xvsusdt','qtumusdt','flmusdt','cosusdt','manausdt','jstusdt']

channels = ['kline_1m']

market_caps7 = ['ETCUSDT']
market_caps8 = ['MKRUSDT']
market_caps9 = ['ZENUSDT']
market_caps10 = ['CRVUSDT']
market_caps11 = ['XVSUSDT']
market_caps12 = ['QTUMUSDT']
market_caps13 = ['FLMUSDT']
market_caps14 = ['COSUSDT']
market_caps15 = ['MANAUSDT']
market_caps16 = ['JSTUSDT']
