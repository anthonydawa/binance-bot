...
from algov22 import AverageTrueRange, idx_array, initial_klines, ExpMa, watch_closed, watch_data, watch_loss
...
markets = ['manausdt','maticusdt','zilusdt','grtusdt','wavesusdt','ontusdt','qtumusdt','rvnusdt','tfuelusdt','zenusdt','zrxusdt','bntusdt','rsrusdt','fetusdt','celousdt','omgusdt','oneusdt','stmxusdt','ankrusdt','reefusdt']

channels = ['kline_5m']

market_caps = ['MANAUSDT']
market_caps2 = ['MATICUSDT']
market_caps3 = ['ZILUSDT']
market_caps4 = ['GRTUSDT']
market_caps5 = ['WAVESUSDT']
market_caps6 = ['ONTUSDT']
market_caps7 = ['QTUMUSDT']
market_caps8 = ['RVNUSDT']
market_caps9 = ['TFUELUSDT']
market_caps10 = ['ZENUSDT']
market_caps11 = ['ZRXUSDT']
market_caps12 = ['BNTUSDT']
market_caps13 = ['RSRUSDT']
market_caps14 = ['FETUSDT']
market_caps15 = ['CELOUSDT']
market_caps16 = ['OMGUSDT']
market_caps17 = ['ONEUSDT']
market_caps18 = ['STMXUSDT']
market_caps19 = ['ANKRUSDT']
market_caps20 = ['REEFUSDT']
